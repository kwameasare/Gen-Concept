...
// func getBodyProperties(cat uint) *[]models.Property {
...
// func getEngineProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
// 			Name:        "Displacement",
// 			CategoryId:  cat,
...
// func getDrivetrainProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
// 			Name:        "Gears",
// 			CategoryId:  cat,
...
// func getSuspensionProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
// 			Name:        "Front brakes",
// 			CategoryId:  cat,
...
// func getComfortProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
// 			Name:        "Central lock",
// 			CategoryId:  cat,
...
// func getDriverSupportSystemProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
// 			Name:        "Parking radar",
// 			CategoryId:  cat,
...
// func getLightsProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
// 			Name:        "Low beam",
// 			CategoryId:  cat,
...
// func getMultimediaProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
// 			Name:        "Bluetooth",
// 			CategoryId:  cat,
...
// func getSafetyEquipmentProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
...
// func getSeatsProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
...
// func getWindowsProperties(cat uint) *[]models.Property {
// 	var props []models.Property = []models.Property{
// 		{
// 			Name:        "Power windows",
// 			CategoryId:  cat,
